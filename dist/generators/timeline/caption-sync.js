 ...
 * ```
 */
export function alignCaptionsToAudio(text, wordTimings) {
 ...
 * ```
 */
export function estimateCaptionTimings(text, startOffset = 0, wpm = DEFAULT_WPM) {
    const sentences = splitIntoSentences(text);
    if (sentences.length === 0) {
        return [];
    }
 ...
 */
export function scaleCaptionsToAudioDuration(captions, targetDuration) {
...
//# sourceMappingURL=caption-sync.js.map