 ...
 */
export type AudioGenerator<TOptions extends AudioGeneratorOptions> = (slides: SlideContent[], options: TOptions) => Promise<AudioManifest | AudioManifestWithTimings>;
/**
...
export declare const KOKORO_VOICES: {
    readonly af_heart: "Warm, friendly female voice";
    readonly af_bella: "Clear, professional female voice";
    readonly af_nova: "Energetic female voice";
    readonly af_sky: "Light, airy female voice";
    readonly am_adam: "Deep, authoritative male voice";
    readonly am_echo: "Smooth male voice";
    readonly bf_alice: "British female voice";
    readonly bf_emma: "British female voice";
    readonly bm_daniel: "British male voice";
    readonly bm_george: "British male voice";
};
