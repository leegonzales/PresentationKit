 ...
 */
function generateSlidesJs(slides) {
 ...
 */
function generateSectionsJs(sections) {
 ...
 */
function generateScript(slides, sections, metadata, options) {
 ...
 */
export function generateHtmlPresentation(metadata, slides, sections, options) {
