 ...
 */
export declare const QUALITY_PRESETS: Record<VideoQuality, Resolution>;
/**
 * Codec to Remotion codec mapping.
 */
export declare const CODEC_MAP: Record<VideoCodec, string>;
/**
 ...
 */
export declare const DEFAULT_CAPTION_CONFIG: CaptionConfig;
/**
 * Default transition configuration.
 */
export declare const DEFAULT_TRANSITION_DURATION = 0.3;
/**
 * Default video configuration.
 */
export declare const DEFAULT_VIDEO_CONFIG: Omit<VideoConfig, 'durationInFrames'>;
