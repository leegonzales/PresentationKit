...
import { z } from 'zod';
import { validateSlug, validateSection, validateImagePath, validateHexColor, findDuplicateSlugs, } from './validators.js';
// -----------------------------------------------------------------------------
// Zod Schemas
// -----------------------------------------------------------------------------
 ...
 */
function parseSlidesTable(content, sections) {
 ...
 */
function parseSemanticTags(audioText) {
    const tags = [];
 ...
 */
export function stripSemanticTags(audioText) {
    return audioText
 ...
 */
function parseSlideContent(content, slides) {
    const slideContent = new Map();
    const errors = [];
 ...
 * ```
 */
export function parseTalkTrack(content) {
 ...
 */
export function safeParseTalkTrack(content) {
    try {
 ...
 */
export function validateTalkTrack(content) {
    const result = safeParseTalkTrack(content);
    return result.errors ?? [];
}
//# sourceMappingURL=talk-track.js.map