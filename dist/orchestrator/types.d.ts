 ...
 */
export type BuildState = 'init' | 'parsing' | 'generating_audio' | 'building_timeline' | 'rendering_html' | 'rendering_video' | 'rendering_notes' | 'complete' | 'failed';
/**
 ...
 */
export declare const VIDEO_QUALITY_RESOLUTION: Record<VideoQuality, {
    width: number;
    height: number;
}>;
/**
